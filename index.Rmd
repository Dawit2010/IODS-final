...
- linear regression of the GNI variable , Linear regression of HDI as well ??
...
The script used for preparing this dataset can be found here:https://github.com/Dawit2010/IODS-final/blob/master/dataWrangling.R
